  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // 오프라인 학습 섹션
          _buildSectionHeader('离线学习 / 오프라인 학습'),
          _buildFAQItem(
          ...
          // 저장공간 관리 섹션
          _buildSectionHeader('存储管理 / 저장공간 관리'),
          _buildFAQItem(
          ...
          // 알림 설정 섹션
          _buildSectionHeader('通知设置 / 알림 설정'),
          _buildFAQItem(
          ...
          // 언어 설정 섹션
          _buildSectionHeader('语言设置 / 언어 설정'),
          _buildFAQItem(
          ...
          // 일반 사항 섹션
          _buildSectionHeader('常见问题 / 일반 FAQ'),
          _buildFAQItem(
