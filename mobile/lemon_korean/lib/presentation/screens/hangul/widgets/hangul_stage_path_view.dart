...
class HangulStagePathView extends StatelessWidget {
  final List<({int stage, String title, String subtitle})> stages; // 13 items (stages 0-12)
  final List<double> stageProgress; // 13 items, mastery 0-5
  final List<StageVisualState> stageStates; // 13 items
  ...
  Widget build(BuildContext context) {
    final totalNodes = stages.length + 1; // stages + 1 BOSS
...
class _HangulPathPainter extends CustomPainter {
  ...
  final List<double> stageProgress; // mastery 0-5 for each stage
  final Color levelColor;
