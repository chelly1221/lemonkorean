...
import 'stage12_lesson_content.dart';

/// Shows the lessons of Stage 12 (간단한 문장 읽기) with completion status.
class HangulStage12LessonListScreen extends StatelessWidget {
  const HangulStage12LessonListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context);

    final lessons = getStage12Lessons(l10n!);

    return Scaffold(
      appBar: AppBar(title: const Text('12단계: 간단한 문장 읽기')),
