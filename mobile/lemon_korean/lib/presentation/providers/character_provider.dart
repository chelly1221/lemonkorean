...
class CharacterProvider with ChangeNotifier {
  ...
  static final List<CharacterItemModel> bundledDefaults = [
    CharacterItemModel(
        ...
        isDefault: true,
        metadata:
            _spriteMeta('assets/sprites/character/body/body_default.png')),
    CharacterItemModel(
        id: 2,
        category: 'hair',
        name: 'Short Hair',
        assetKey: 'assets/sprites/character/hair/hair_short.png',
        assetType: 'spritesheet',
        isBundled: true,
        renderOrder: 40,
        isDefault: true,
        metadata: _spriteMeta('assets/sprites/character/hair/hair_short.png')),
    CharacterItemModel(
        id: 3,
        category: 'hair',
        name: 'Long Hair',
        assetKey: 'assets/character/hair/hair_long.svg',
        isBundled: true,
        renderOrder: 40),
    CharacterItemModel(
        id: 4,
        category: 'hair',
        name: 'Curly Hair',
        assetKey: 'assets/character/hair/hair_curly.svg',
        isBundled: true,
        renderOrder: 40),
    CharacterItemModel(
        id: 5,
        category: 'eyes',
        name: 'Round Eyes',
        assetKey: 'assets/sprites/character/eyes/eyes_round.png',
        assetType: 'spritesheet',
        isBundled: true,
        renderOrder: 20,
        isDefault: true,
        metadata: _spriteMeta('assets/sprites/character/eyes/eyes_round.png')),
    CharacterItemModel(
        id: 6,
        category: 'eyes',
        name: 'Almond Eyes',
        assetKey: 'assets/character/eyes/eyes_almond.svg',
        isBundled: true,
        renderOrder: 20),
    CharacterItemModel(
        id: 7,
        category: 'eyes',
        name: 'Happy Eyes',
        assetKey: 'assets/character/eyes/eyes_happy.svg',
        isBundled: true,
        renderOrder: 20),
    CharacterItemModel(
        id: 8,
        category: 'eyebrows',
        name: 'Natural Brows',
        assetKey: 'assets/sprites/character/eyebrows/eyebrows_natural.png',
        assetType: 'spritesheet',
        isBundled: true,
        renderOrder: 25,
        isDefault: true,
        metadata: _spriteMeta(
            'assets/sprites/character/eyebrows/eyebrows_natural.png')),
    CharacterItemModel(
        id: 9,
        category: 'eyebrows',
        name: 'Thick Brows',
        assetKey: 'assets/character/eyebrows/eyebrows_thick.svg',
        isBundled: true,
        renderOrder: 25),
    CharacterItemModel(
        id: 10,
        category: 'nose',
        name: 'Button Nose',
        assetKey: 'assets/sprites/character/nose/nose_button.png',
        assetType: 'spritesheet',
        isBundled: true,
        renderOrder: 30,
        isDefault: true,
        metadata: _spriteMeta('assets/sprites/character/nose/nose_button.png')),
    CharacterItemModel(
        id: 11,
        category: 'nose',
        name: 'Small Nose',
        assetKey: 'assets/character/nose/nose_small.svg',
        isBundled: true,
        renderOrder: 30),
    CharacterItemModel(
        id: 12,
        category: 'mouth',
        name: 'Smile',
        assetKey: 'assets/sprites/character/mouth/mouth_smile.png',
        assetType: 'spritesheet',
        isBundled: true,
        renderOrder: 35,
        isDefault: true,
        metadata:
            _spriteMeta('assets/sprites/character/mouth/mouth_smile.png')),
    CharacterItemModel(
        id: 13,
        category: 'mouth',
        name: 'Grin',
        assetKey: 'assets/character/mouth/mouth_grin.svg',
        isBundled: true,
        renderOrder: 35),
    CharacterItemModel(
        id: 14,
        category: 'top',
        name: 'Basic T-Shirt',
        assetKey: 'assets/sprites/character/top/top_tshirt.png',
        assetType: 'spritesheet',
        isBundled: true,
        renderOrder: 50,
        isDefault: true,
        metadata: _spriteMeta('assets/sprites/character/top/top_tshirt.png')),
    CharacterItemModel(
        id: 15,
        category: 'top',
        name: 'Hoodie',
        assetKey: 'assets/character/top/top_hoodie.svg',
        isBundled: true,
        renderOrder: 50,
        price: 10),
    CharacterItemModel(
        ...
        category: 'bottom',
        name: 'Jeans',
        assetKey: 'assets/character/bottom/bottom_jeans.svg',
        isBundled: true,
        renderOrder: 55,
        isDefault: true),
    CharacterItemModel(
        ...
        category: 'bottom',
        name: 'Shorts',
        assetKey: 'assets/character/bottom/bottom_shorts.svg',
        isBundled: true,
        renderOrder: 55,
        price: 10),
    CharacterItemModel(
        ...
        assetKey: 'assets/character/wallpaper/wall_light_blue.svg',
        isBundled: true,
        renderOrder: 0,
        isDefault: true),
    CharacterItemModel(
        id: 19,
        category: 'wallpaper',
        name: 'Warm Yellow Wall',
        assetKey: 'assets/character/wallpaper/wall_warm_yellow.svg',
        isBundled: true,
        renderOrder: 0,
        price: 15),
    CharacterItemModel(
        ...
        category: 'floor',
        name: 'Wooden Floor',
        assetKey: 'assets/character/floor/floor_wood.svg',
        isBundled: true,
        renderOrder: 0,
        isDefault: true),
    CharacterItemModel(
        ...
        category: 'floor',
        name: 'Tile Floor',
        assetKey: 'assets/character/floor/floor_tile.svg',
        isBundled: true,
        renderOrder: 0,
        price: 15),
  ];
  ...
  List<Map<String, dynamic>> get roomFurniture =>
      List.unmodifiable(_roomFurniture);
  ...
  Future<void> loadFromStorage() async {
    ...
    for (final raw in invItems) {
      try {
        final item =
            CharacterItemModel.fromJson(Map<String, dynamic>.from(raw));
        _inventory.add(item);
    ...
    // Offline-first defaults for fresh installs.
    if (_inventory.isEmpty) {
      await initializeDefaults(
        bundledDefaults
            .where((item) => item.isDefault || item.isBundled)
            .toList(),
      );
    }
  ...
  Future<void> equipItem(String category, int itemId) async {
    ...
    await LocalStorage.saveToBox(
        _characterBox, 'equipped', _character.toJson());
  ...
  Future<bool> purchaseItem(CharacterItemModel item) async {
    ...
    // Save to local storage
    await LocalStorage.saveToBox(
        _inventoryBox, 'item_${item.id}', item.toJson());
  ...
  Future<List<CharacterItemModel>> fetchShopItems(String? category) async {
    ...
    try {
      ...
      for (final item in items) {
        ...
        await LocalStorage.saveToBox(
            _shopCacheBox, 'item_${item.id}', item.toJson());
      }
